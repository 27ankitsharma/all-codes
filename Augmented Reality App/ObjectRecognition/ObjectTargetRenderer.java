...
public class ObjectTargetRenderer implements GLSurfaceView.Renderer
{
    ...
    // The render function.
      ObjectTargets objtarget = new ObjectTargets(); //Creating instance to obtain various items such as json object,
    ...
    private void renderFrame()
    {
        ...
        ListOfDatasetFiles = ObjectTargets.DatasetFilesNamesList;  // List to store names of all dataset files present in the device dataset.. 
        JSONArray textureListForAFile = null;    // List to store textures files for each item in dataset.
        
		 jsonObj = ObjectTargets.jsonObj;
        ...
        textureNameList = ObjectTargets.texturesNameList;
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            Matrix.translateM(modelViewMatrix1, 0, 170, 60, 4);
            
            Matrix.scaleM(modelViewMatrix1, 0, objectSize[0]/4,
                objectSize[1]/4, 4);
            ...
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D,
                mTextures.get(textureIndex1).mTextureID[0]);  //in get(0), put textureIndex
             //GLES20.glBindTexture(GLES20.GL_TEXTURE_2D,
              //  mTextures.get(0).mTextureID[1]);
            ...
            if(plane2) {	
                ...
                Matrix.translateM(modelViewMatrix2, 0, 60, -30, 4);
                
                Matrix.scaleM(modelViewMatrix2, 0, objectSize[0]/4,
                    objectSize[1]/4, 4);
            ...
            if(plane3) {	
                ...
                Matrix.translateM(modelViewMatrix3, 0, -50, 90, 4);
                
                Matrix.scaleM(modelViewMatrix3, 0, objectSize[0]/4,
                    objectSize[1]/4, 4);
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
                GLES20.glBindTexture(GLES20.GL_TEXTURE_2D,
                    mTextures.get(textureIndex3).mTextureID[0]);  //in get(0), put textureIndex
                 //GLES20.glBindTexture(GLES20.GL_TEXTURE_2D,
                  //  mTextures.get(0).mTextureID[1]);
                GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false,
                    modelViewProjection, 0);
